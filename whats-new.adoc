...
Il supporto attuale è per i volumi su sistemi Cloud Volumes ONTAP e ONTAP on-premise. https://docs.netapp.com/us-en/cloud-manager-app-template/task-define-templates.html#find-existing-volumes-and-activate-bluexp-backup-and-recovery["Fai clic qui per ulteriori informazioni"].
...
https://docs.netapp.com/us-en/cloud-manager-app-template/concept-tagging.html["Scopri di più sull'etichettatura delle risorse"].
